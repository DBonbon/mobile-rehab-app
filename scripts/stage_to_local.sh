...
readonly LOCAL_DOMAIN=savima.org.test:8081
readonly SSH_HOST=deploy@stage.savima.org
...
ssh $SSH_HOST "export PGUSER=postgres && pg_dump savima --no-owner > /tmp/db-dump.sql"
