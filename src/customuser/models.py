...
class User(AbstractUser):
    display_name = models.CharField(verbose_name=_("Display name"), max_length=30, 
                                   help_text=_("Will be shown e.g. when commenting"), blank=True, null=True)
    ...
    mobile_phone = models.CharField(validators=[phone_regex], verbose_name=_("Mobile phone"), 
                                  max_length=17, blank=True, null=True)
    role = models.CharField(choices=ROLES, max_length=50, default='regular_user', 
                          help_text=_("Click below Collaborator, if you wish to join us"))
    additional_information = models.CharField(verbose_name=_("Additional information"), 
    ...
    def get_absolute_url(self):
        return reverse('user-detail', kwargs={'pk': self.pk})  # Changed to API endpoint
